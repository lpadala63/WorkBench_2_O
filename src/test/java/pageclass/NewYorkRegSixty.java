...
public class NewYorkRegSixty extends GlobalCap{
    ...
    By continuetoBeinfore_yes=By.xpath("//label[contains(text(),'CONTINUE TO BE IN FORCE')]//following::input[@alt_id='NYR60_ReducedYesNo_1']");
    By continuetoBeinfore_No=By.xpath("//label[contains(text(),'CONTINUE TO BE IN FORCE')]//following::input[@alt_id='NYR60_ReducedYesNo_2']");
	...
	By heading=By.xpath("//h1[contains(text(),'New York Reg 60')]");

	public void NeyworkReg(String State, String Lapsed, String CashValues, String tobeInforce, String Reissued, String Collateral,
			String Premium, String externalReplacement) {
		if (State.equalsIgnoreCase("New York")) {
			...
			GlobalCap.selectRadioYesorNo(continuetoBeinfore_yes, continuetoBeinfore_No, tobeInforce);
