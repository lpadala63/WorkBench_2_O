...
public class Apextest {
	...
	public void launch_Fieldnet_Dev_application_to_Enter_UserID_and_Password_click_Next(int arg1) throws Throwable {
	...
	public void user_Fills_VUL_Life_Product_Screen_details_and_click_on_Next() throws Throwable {
		...
		VUL.enterproductUL(Frequency, PlannedPremiumamount, UnsheduledPremium1035, DeathBenefitOption_DD, DefinitionOfLifeInsurance);
	...
	public void user_Fills_VUL_Life_Producer_Statement_screen_details_and_click_on_Next() throws IOException {
		...
		String Prospectusandany = ReadData.get(HooksTest.scenario.getName(), FileName,SheetName,
				"Prospectusandany");
		
		String Prospectus_MM = ReadData.get(HooksTest.scenario.getName(), FileName,SheetName,
				"Prospectus_MM");
		String Prospectus_DD = ReadData.get(HooksTest.scenario.getName(), FileName,SheetName,
				"Prospectus_DD");
		String Prospectus_YYYY = ReadData.get(HooksTest.scenario.getName(), FileName,SheetName,
				"Prospectus_YYYY");
	...
	public void user_Fills_VUL_Life_Producer_Compensation_screen_details_and_click_on_Next() throws IOException {
		...
		String Blend = ReadData.get(HooksTest.scenario.getName(), FileName,SheetName,"Blend");
		...
		ALocationscree1.Allocation_directedMonthly(startDate_Month, startDate_Year, cancellationDate_Month, cancellationDate_Year, investmentOption, Cboe, protofolio_Frequency, protofolio_Startdate,
