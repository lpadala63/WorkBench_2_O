...
public class ExcelUtility {
	...
	String rowcountfilepath="";
	//get row count of a sheet
	public static int getRowCount(String filePath, String sheetName) throws IOException
	{
		int rowCount;
		File file = new File("\\\\mmdata3b1r1\\Image_WF\\0STP\\5e-Application\\2PlanningA_D\\6Quality_Testing\\eApp\\eApp Modules\\eApp - TeleApp\\Testing\\11. TPP Vs. Batch\\GCC_NBS_Ind\\Automation_EzApp_IGO\\EZ-App\\"+filePath+".xlsx");
